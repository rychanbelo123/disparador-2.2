          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/60 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl overflow-hidden">
              ...
              <a
                ...
                className="w-full inline-block bg-green-600 hover:bg-green-700 text-white font-medium h-12 rounded-xl transition-colors duration-300 text-center leading-[3rem] select-none"
              >
                Solicitar Conta
              </a>
