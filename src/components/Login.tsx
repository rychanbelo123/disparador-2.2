...
import { MessageCircle, Smartphone, Lock, Eye, EyeOff, ArrowRight } from "lucide-react";
          ...
          <div className="relative group">
            ...
            <div className="relative bg-black/60 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl overflow-hidden">
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-6">
                <div className="relative" onFocus={() => setFocusedInput("email")} onBlur={() => setFocusedInput(null)}>
                ...
                <div className="relative" onFocus={() => setFocusedInput("senha")} onBlur={() => setFocusedInput(null)}>
